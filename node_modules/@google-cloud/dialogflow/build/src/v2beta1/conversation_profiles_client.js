...
class ConversationProfilesClient {
    ...
    async checkSetSuggestionFeatureConfigProgress(name) {
        ...
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.setSuggestionFeatureConfig, gax.createDefaultBackoffSettings());
    ...
    async checkClearSuggestionFeatureConfigProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.clearSuggestionFeatureConfig, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
